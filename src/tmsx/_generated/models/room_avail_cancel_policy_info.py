...
T = TypeVar("T", bound="RoomAvailCancelPolicyInfo")


@_attrs_define
class RoomAvailCancelPolicyInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        room_avail_cancel_policy_info = cls(
            amount=amount,
        ...
        room_avail_cancel_policy_info.additional_properties = d
        return room_avail_cancel_policy_info
