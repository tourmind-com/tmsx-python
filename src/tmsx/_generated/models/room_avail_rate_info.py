...
if TYPE_CHECKING:
    from ..models.room_avail_cancel_policy_info import RoomAvailCancelPolicyInfo
    from ..models.room_avail_daily_price_info import RoomAvailDailyPriceInfo
    from ..models.room_avail_meal_info import RoomAvailMealInfo


T = TypeVar("T", bound="RoomAvailRateInfo")


@_attrs_define
class RoomAvailRateInfo:
    """
    Attributes:
        allotment (int | Unset): Available room inventory count. Example: 2.
        cancel_policy_infos (list[RoomAvailCancelPolicyInfo] | Unset): Cancellation policy information.
        currency_code (str | Unset): Currency code. Example: CNY.
        daily_price_info (list[RoomAvailDailyPriceInfo] | Unset): Daily pricing information for the hotel.
        meal_info (RoomAvailMealInfo | Unset):
    ...
    cancel_policy_infos: list[RoomAvailCancelPolicyInfo] | Unset = UNSET
    currency_code: str | Unset = UNSET
    daily_price_info: list[RoomAvailDailyPriceInfo] | Unset = UNSET
    meal_info: RoomAvailMealInfo | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _cancel_policy_infos is not UNSET:
            ...
            for cancel_policy_infos_item_data in _cancel_policy_infos:
                cancel_policy_infos_item = RoomAvailCancelPolicyInfo.from_dict(
        ...
        if _daily_price_info is not UNSET:
            ...
            for daily_price_info_item_data in _daily_price_info:
                daily_price_info_item = RoomAvailDailyPriceInfo.from_dict(
        ...
        if isinstance(_meal_info, Unset):
            ...
            meal_info = RoomAvailMealInfo.from_dict(_meal_info)
        ...
        room_avail_rate_info.additional_properties = d
        return room_avail_rate_info
