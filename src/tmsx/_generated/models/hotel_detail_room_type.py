...
if TYPE_CHECKING:
    from ..models.hotel_detail_rate_info import HotelDetailRateInfo


T = TypeVar("T", bound="HotelDetailRoomType")


@_attrs_define
class HotelDetailRoomType:
    """
    Attributes:
        ...
        rate_infos (list[HotelDetailRateInfo] | Unset): A list of rates for a room type; at least one rate will be
            returned.
    ...
    rate_infos: list[HotelDetailRateInfo] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _rate_infos is not UNSET:
            ...
            for rate_infos_item_data in _rate_infos:
                rate_infos_item = HotelDetailRateInfo.from_dict(rate_infos_item_data)

                rate_infos.append(rate_infos_item)

        room_type_code = d.pop("RoomTypeCode", UNSET)

        hotel_detail_room_type = cls(
        ...
        hotel_detail_room_type.additional_properties = d
        return hotel_detail_room_type
