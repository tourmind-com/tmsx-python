...
T = TypeVar("T", bound="CancelOrderCancelOrderRequest")


@_attrs_define
class CancelOrderCancelOrderRequest:
    """
    Attributes:
        agent_ref_id (str | Unset): Agent reference ID provided in the CreateOrder request by the agent; maximum length
            is 128. Example: 213415.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cancel_order_cancel_order_request = cls(
            agent_ref_id=agent_ref_id,
            request_header=request_header,
        )

        cancel_order_cancel_order_request.additional_properties = d
        return cancel_order_cancel_order_request
