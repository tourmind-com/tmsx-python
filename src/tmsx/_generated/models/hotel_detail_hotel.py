...
if TYPE_CHECKING:
    from ..models.hotel_detail_room_type import HotelDetailRoomType


T = TypeVar("T", bound="HotelDetailHotel")


@_attrs_define
class HotelDetailHotel:
    """
    Attributes:
        ...
        room_types (list[HotelDetailRoomType] | Unset): Room types available based on the search criteria.
    """

    check_in: str | Unset = UNSET
    check_out: str | Unset = UNSET
    hotel_code: str | Unset = UNSET
    room_types: list[HotelDetailRoomType] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _room_types is not UNSET:
            ...
            for room_types_item_data in _room_types:
                room_types_item = HotelDetailRoomType.from_dict(room_types_item_data)

                room_types.append(room_types_item)

        hotel_detail_hotel = cls(
            check_in=check_in,
            check_out=check_out,
        ...
        hotel_detail_hotel.additional_properties = d
        return hotel_detail_hotel
