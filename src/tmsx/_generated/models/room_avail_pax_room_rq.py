...
T = TypeVar("T", bound="RoomAvailPaxRoomRQ")


@_attrs_define
class RoomAvailPaxRoomRQ:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        room_avail_pax_room_rq.additional_properties = d
        return room_avail_pax_room_rq
